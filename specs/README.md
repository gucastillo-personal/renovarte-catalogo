...
| 0016 | Chat conversacional embebido ("Colibrí"): a partir de tipo de piel + presupuesto, recomienda 3 combos de cremas (más barato/medio/premium) con productos reales del catálogo. Toca 3 repos (este + 2 nuevos, `renovarte-chat-gateway`/`renovarte-colibri-rag`) — spec completo, `ux.md`, `plan.md`/`tasks.md` y RFC viven centralizados en [`renovarte-parent/specs/0016-chat-recomendador-cremas/`](../../specs/0016-chat-recomendador-cremas/spec.md), no acá; este repo solo registra los requisitos (RF-14, RNF-06..09) más abajo | Backlog — diseño listo, ver root |
...
| RF-14 | Chat conversacional embebido ("Colibrí"): tipo de piel + presupuesto → 3 combos de cremas (más barato/medio/premium, cada uno 2+ productos reales) con productos reales del catálogo, nunca inventados; "más barato"/"medio" ≤ presupuesto, "premium" ≤ presupuesto × 1.20 | [0016 (root)](../../specs/0016-chat-recomendador-cremas/spec.md) | Backlog — conflicto con `constitution.md §II.4` resuelto (runtime nunca vive en `renovarte-catalogo`, ver RNF-08); sin preguntas abiertas (techo de costo de la API de Claude resuelto vía RNF-09), diseño listo, spec/plan/RFC en `renovarte-parent` |
| RNF-06 | El chat no expone credenciales de terceros ni costo/margen real | [0016 (root)](../../specs/0016-chat-recomendador-cremas/spec.md) | Backlog |
| RNF-07 | El catálogo (RF-01 a RF-04) sigue funcionando si el chat no está disponible | [0016 (root)](../../specs/0016-chat-recomendador-cremas/spec.md) | Backlog |
| RNF-08 | El runtime del chat (transporte en vivo, conexión al LLM, RAG) vive exclusivamente fuera de `renovarte-catalogo`; este repo nunca aloja backend/runtime propio | [0016 (root)](../../specs/0016-chat-recomendador-cremas/spec.md) | Backlog |
| RNF-09 | Techo de gasto mensual de la API del LLM (USD 20/mes); al alcanzarlo, el chat se deshabilita automáticamente y el resto del catálogo sigue funcionando sin degradación | [0016 (root)](../../specs/0016-chat-recomendador-cremas/spec.md) | Backlog — excepción explícita y acotada al chat al invariante "$0 infra" (RNF-01 / `constitution.md §II.5`), aprobada por el CTO/CEO |
